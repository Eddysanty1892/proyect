...
<script>
    document.getElementById('editarBtn').addEventListener('click', function() {
        let campos = document.querySelectorAll('.editable');
        campos.forEach(campo => campo.removeAttribute('disabled')); // Habilita los campos
        document.getElementById('guardarBtn').classList.remove('d-none'); // Muestra el botón Guardar
